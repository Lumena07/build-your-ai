...
const names=['index.html','styles.css','classroom.css','runtime-config.js','gpu-client.js','curriculum.js','experience.js','journey.js','lesson-design.js','course-session.js','realtime-eve.js','app.js','assets/eve-teacher.png'];
