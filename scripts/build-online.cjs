...
const names=['index.html','styles.css','classroom.css','runtime-config.js','blocks/learning-journey/index.js','blocks/classroom-ui/index.js','blocks/eve-teacher/index.js','gpu-client.js','curriculum.js','experience.js','journey.js','lesson-design.js','course-session.js','realtime-eve.js','app.js','assets/eve-teacher.png'];
...
const instructions=cp.execFileSync(python,[path.join(root,'scripts/export-teacher-prompt.py')],{encoding:'utf8',env:{...process.env,PYTHONUTF8:'1'}});
