...
export function realtimeContext(body){
 ...
 const questionRule=body.current_question?'WRITING MODE: A writable text area is visible. Ask only this exact current question: '+body.current_question+' Tell the learner to type in the box. Never ask for a spoken answer or add a second question.':'EXPLAIN MODE: No writable text area is visible. You MUST NOT ask a question, use a question mark, say “tell me”, “what do you think”, “can you”, “would you”, “choose”, “try”, or request any response. End with a complete teaching statement. Buttons and multiple-choice options are handled by the page.';
